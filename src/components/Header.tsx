...
export default function Header() {
  ...
  return (
    <header className="bg-transparent shadow text-white py-8">
      <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-4">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="https://www.fab.mil.br/">
            <Image src="/images/gladio-cinza1.png" alt="FAB" width={80} height={80} />
          </Link>
        ...
        <div className="flex flex-col text-center">
          ...
          <span className="text-lg md:text-xl text-gray-300">Centro de Computação da Aeronáutica de Brasília</span>
        </div>
        {}
